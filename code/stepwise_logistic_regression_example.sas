...
proc logistic data=Remission outest=betas covout;
      model remiss(event='1')=cell smear infil li blast temp
                   / selection=stepwise
                     slentry=0.3 /* A sig level of .3 is required to allow a variable into the model (SLENTRY=.3)*/
                     slstay=0.35 /* A sig level of .35 is required to allow a variable stay in the model (SLstay=.35)*/
                     details
                     lackfit; /*The Hosmer and Lemeshow goodness-of-fit test for the final selected model 
